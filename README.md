...
As "Open Internet Access by Molecular Dynamics Simulations", a couple of various codes are shown in https://github.com/Mtanaka77/. This page is discussed on the large-scale electromagnetic code (J. Comp. Physics, 1993, Ref. 1), and to study magnetospheric plasmas including magnetic reconnection (Phys. Plasmas, 1995, Ref. 3). 
