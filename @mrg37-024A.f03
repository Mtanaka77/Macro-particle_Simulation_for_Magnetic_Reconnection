...
!
!*  kstart..... used in /init/, /trans/, /fulmov/, in param_A24A.h.
!   Ez00   .... Ez00 x Ba
!
...
!   poissn:
!  ++++++++++++++++++++++++++++++++++++++++++++++++++++
!     kd= mz/npc is defined in param_A24A.h
!
!             number_of_cpu's
      do k= 1,npc         
...
!----------------------------------------------------------------------
      ...
      implicit none
!
      include 'param_A24A.h'  !<-- mx,myA,mz,iblk in param_A24A.h
!
